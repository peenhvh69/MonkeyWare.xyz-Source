...
namespace vtable_indexes
{
	...
	constexpr auto writeUserCmdToBuf = 24;
}
...
public:
	...
	// MOE doubletap
	static bool __fastcall WriteUsercmdDeltaToBufferHook(void* ecx, void* edx, int slot, void* buf, int from, int to, bool isnewcommand);
private:
    /*---------------------------------------------*/
    /*-------------VMT Hook pointers---------------*/
    /*---------------------------------------------*/
	...
	// Adding doubletap hook
	typedef bool(__thiscall* WriteUsercmdDeltaToBuffer_t)(void*, int, void*, int, int, bool);
private:
