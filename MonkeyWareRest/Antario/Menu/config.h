...
public:
	...
	*/
	...
	int local_fake_chams_r = 255, local_fake_chams_g = 255, local_fake_chams_b = 255, local_fake_chams_a = 255;
	...
	bool removers[4] = { false, false , false, false };
	...
	int watermark_y_value = 0;
	int watermark_x_value = 0;
