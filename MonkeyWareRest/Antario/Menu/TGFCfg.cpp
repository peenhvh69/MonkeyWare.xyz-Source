...
void CConfig::Setup()
{
	...
	SetupValue(c_config::get().removers, false, 4, "visuals", "Removers");
	...
	*/
	...
	SetupValue(c_config::get().local_fake_chams, false, "Visuals", "Fake Chams");
	...
	SetupValue(c_config::get().local_fake_chams_r, 255, "Visuals", "local_fake_chams_r");
	SetupValue(c_config::get().local_fake_chams_g, 255, "Visuals", "local_fake_chams_g");
	SetupValue(c_config::get().local_fake_chams_b, 255, "Visuals", "local_fake_chams_b");
	SetupValue(c_config::get().local_fake_chams_a, 255, "Visuals", "local_fake_chams_a");
	...
	SetupValue(c_config::get().watermark_y_value, 0, "Misc", "watermark_y_value");
	SetupValue(c_config::get().watermark_x_value, 0, "Misc", "watermark_x_value");
